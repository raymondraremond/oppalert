  ...
  return (
    <div className="h-full group">
      <Link 
        ...
        className="flex flex-col h-full bg-surface/30 border border-border/60 rounded-[2.5rem] overflow-hidden backdrop-blur-md transition-all duration-500 hover:border-amber/40 hover:shadow-2xl hover:shadow-amber/5 active:scale-[0.98] relative"
      >
        {/* Top Image Section */}
        <div className="relative w-full h-52 overflow-hidden bg-surface2">
          ...
          {opp.is_featured && (
            <div className="absolute top-4 right-14 z-20">
              <span className="px-3 py-1.5 bg-amber text-black rounded-full text-[9px] font-black uppercase tracking-widest shadow-lg shadow-amber/20">
                FEATURED
              </span>
            </div>
          )}
          ...
          >
            <div className="w-9 h-9 rounded-2xl bg-black/60 backdrop-blur-md border border-white/10 flex items-center justify-center hover:bg-amber hover:text-black hover:border-amber transition-all duration-300 shadow-xl group/save">
          ...
          <div className="absolute inset-0 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity bg-black/20 backdrop-blur-[2px] pointer-events-none">
             <div className="w-12 h-12 rounded-full bg-amber/90 text-black flex items-center justify-center shadow-2xl scale-50 group-hover:scale-100 transition-transform duration-500">
        ...
        <div className="p-8 flex flex-col flex-grow relative">
          <div className="flex items-center gap-3 mb-5">
            <span className="text-[10px] font-black uppercase tracking-[0.25em] text-amber">
              {cat.replace('-', ' ')}
            </span>
          ...
          {/* Footer Meta */}
          <div className="pt-6 border-t border-border/40 flex justify-between items-center transition-colors group-hover:border-amber/20">
            <div className="flex items-center gap-3">
              <div className="w-9 h-9 rounded-xl bg-surface2 border border-border flex items-center justify-center text-[11px] font-black text-amber uppercase shadow-inner group-hover:border-amber/30 transition-colors">
