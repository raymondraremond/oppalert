      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-40">
          {[
            ...
            <div key={idx} className="glass-gradient border border-[var(--border)] rounded-[3rem] p-10 hover:border-white/20 transition-all group">
               ...
               <h3 className="font-syne text-xl font-black text-primary mb-4">{pillar.title}</h3>
        ...
        <section className="bg-amber-gradient rounded-[4rem] p-12 md:p-24 text-center text-bg relative overflow-hidden animate-reveal group">
           ...
           <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
             <Link href="/opportunities" className="btn-primary !bg-bg !text-primary px-10 py-5 rounded-2xl font-black uppercase tracking-widest text-xs hover:scale-110 transition-all flex items-center gap-3 shadow-premium">
        ...
        <div className="mt-32 pt-20 border-t border-[var(--border)] flex flex-col items-center gap-12 grayscale opacity-40 hover:grayscale-0 hover:opacity-100 transition-all duration-700">
