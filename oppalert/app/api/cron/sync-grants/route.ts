...
export async function GET() {
  ...
  const feeds = [
    { url: 'https://devex.com/news/rss.xml', source: 'Devex' },
      ...
      try {
        ...
        for (const item of itemArray) {
          try {
            ...
            if (lowerTitle.includes('fellowship') || lowerTitle.includes('fellow')) {
              category = 'fellowship'
              icon = '🌍'
            } else if (lowerTitle.includes('grant') || lowerTitle.includes('funding')) {
              category = 'grant'
              icon = '💰'
            }
            ...
            const dbRes = await query(
              `INSERT INTO opportunities 
               ...
               VALUES ($1,$2,$3,$4,$5,$6,$7,$8,
                       NOW() + INTERVAL '45 days', 45, false, true)
