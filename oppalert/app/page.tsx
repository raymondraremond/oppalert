  ...
  return (
    <main className="min-h-screen bg-bg relative selection:bg-emerald-500/30 selection:text-emerald-100 overflow-hidden">
      ...
      <section className="relative pt-40 pb-32 px-6 flex flex-col items-center justify-center min-h-screen">
        <div className="max-w-6xl mx-auto text-center relative z-10 w-full mb-24">
          <motion.div
          ...
          <motion.p
            ...
            className="text-lg md:text-xl text-muted/70 max-w-2xl mx-auto mb-16 font-medium leading-relaxed"
          >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-5xl mx-auto w-full relative z-10 px-4">
           {/* Seeker Path */}
           <motion.div
           ...
           >
             <Link href="/opportunities" className="block h-full p-10 rounded-[3rem] bg-surface/40 backdrop-blur-3xl border border-white/10 hover:border-emerald-500/30 transition-all duration-500 overflow-hidden">
                ...
                <h3 className="text-3xl font-syne font-bold text-primary mb-4">I am a Seeker</h3>
                <p className="text-muted/70 mb-8 leading-relaxed">Access the most curated database of scholarships, jobs, and grants designed for your success.</p>
