  ...
  return (
    <main className="min-h-screen bg-bg relative selection:bg-emerald-500/30 selection:text-emerald-100 overflow-hidden">
      ...
      <div className="fixed inset-0 pointer-events-none -z-10">
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[800px] h-[800px] bg-emerald-500/5 blur-[120px] rounded-full animate-orb" />
      ...
      <section className="relative pt-32 pb-24 px-6 flex items-center min-h-[95vh]">
        <div className="max-w-[90rem] mx-auto w-full relative z-10 grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24 items-center">
          ...
          <div className="text-left w-full">
            ...
            >
               <div className="inline-flex items-center gap-3 px-4 py-1.5 rounded-full bg-white/5 border border-white/10 backdrop-blur-md mb-8">
                  ...
                  <span className="text-[10px] font-black tracking-[0.3em] uppercase text-emerald-100/70">
            ...
            <AnimatePresence mode="wait">
              <h1 key={heroKey} className="text-6xl md:text-8xl lg:text-[7.5rem] leading-[0.9] text-primary tracking-tighter mb-10 font-syne font-black flex flex-wrap gap-x-6 gap-y-4">
                <motion.span
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-1 xl:grid-cols-2 gap-6 w-full relative z-10">
             ...
             >
               <Link href="/opportunities" className="block h-full p-8 lg:p-10 rounded-[2.5rem] lg:rounded-[3rem] bg-surface/40 backdrop-blur-3xl border border-white/10 hover:border-emerald-500/30 transition-all duration-500 overflow-hidden shadow-2xl">
                  <div className="absolute top-0 right-0 p-8 opacity-5 group-hover:opacity-10 transition-opacity">
                     <Search size={140} />
                  </div>
                  <div className="w-14 h-14 rounded-2xl bg-emerald-500/10 border border-emerald-500/20 flex items-center justify-center mb-6 lg:mb-8 text-emerald-400">
                     <Briefcase size={28} />
                  </div>
                  ...
                  <div className="flex items-center gap-2 text-emerald-400 font-bold text-sm tracking-widest uppercase mt-auto">
             ...
             <motion.div
               ...
               className="group relative h-full"
             >
               <Link href="/organizer" className="block h-full p-8 lg:p-10 rounded-[2.5rem] lg:rounded-[3rem] bg-surface/40 backdrop-blur-3xl border border-white/10 hover:border-emerald-500/30 transition-all duration-500 overflow-hidden shadow-2xl">
                  <div className="absolute top-0 right-0 p-8 opacity-5 group-hover:opacity-10 transition-opacity">
                     <Calendar size={140} className="text-emerald" />
                  </div>
                  <div className="w-14 h-14 rounded-2xl bg-emerald-500/10 border border-emerald-500/20 flex items-center justify-center mb-6 lg:mb-8 text-emerald">
                     <Users size={28} />
                  </div>
      ...
      <section className="py-40 px-6 relative overflow-hidden bg-[#020604]">
        ...
        <div className="max-w-7xl mx-auto container relative z-10">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
            <motion.div
              ...
              className="p-8 md:p-12 rounded-[3.5rem] bg-bg/80 border border-white/10 backdrop-blur-2xl shadow-2xl relative overflow-hidden group"
            >
               {/* Terminal Visual */}
               ...
               <div className="mt-12 py-10 px-8 bg-surface/50 border border-white/5 rounded-3xl min-h-[300px] flex flex-col justify-center">
                  <div className="mb-10 p-6 bg-emerald-500/5 border border-emerald-500/10 rounded-2xl inline-flex items-center gap-4 hover:scale-[1.02] transition-transform">
                  ...
                  <div className="grid grid-cols-3 gap-4">
                     {[1, 2, 3].map(i => (
                        <div key={i} className={`h-24 rounded-2xl border border-white/5 transition-all duration-700 bg-white/${i * 2 + 1}`} 
               ...
               <div className="absolute bottom-8 right-8 flex gap-3">
                  <div className="p-3 bg-white/5 border border-white/10 rounded-xl text-muted hover:text-primary transition-colors cursor-pointer"><Copy size={20} /></div>
                  <div className="p-3 bg-white/5 border border-white/10 rounded-xl text-muted hover:text-primary transition-colors cursor-pointer"><Share2 size={20} /></div>
               </div>
            </motion.div>
            ...
            <motion.div
              ...
              className="space-y-8"
            >
              <div className="inline-flex items-center gap-2 px-3 py-1 bg-emerald-500/10 border border-emerald-500/20 rounded-lg text-[9px] font-black tracking-widest uppercase text-emerald-400">
              ...
              <h2 className="text-4xl md:text-6xl font-syne font-bold text-primary tracking-tighter leading-tight italic">
                Your event link, <br />
                <span className="text-emerald-400 not-italic">instantly developed.</span>
              </h2>
              ...
              <div className="pt-6">
                <Link href="/organizer/create" className="inline-flex items-center gap-4 text-emerald-400 font-black uppercase tracking-[0.2em] hover:opacity-80 transition-opacity">
      ...
      <section className="py-40 px-6 relative border-t border-white/5 overflow-hidden">
        <div className="max-w-7xl mx-auto container relative z-10 text-center">
           ...
           >
              ...
              <div className="mt-20">
                <Link href="/opportunities" className="px-12 py-6 rounded-full bg-primary text-bg font-black uppercase tracking-widest hover:scale-105 transition-transform flex items-center justify-center gap-3 w-fit mx-auto shadow-2xl shadow-emerald-500/10">
      ...
      <section className="py-40 px-6">
        <div className="max-w-6xl mx-auto p-12 md:p-32 rounded-[4rem] bg-surface/30 border border-white/5 backdrop-blur-3xl text-center relative overflow-hidden group">
           <div className="absolute inset-0 bg-emerald-500 opacity-0 group-hover:opacity-5 transition-opacity duration-1000" />
           ...
           <div className="flex flex-col sm:flex-row gap-8 justify-center items-center">
              <Link href="/register" className="px-14 py-7 bg-emerald-500 text-bg font-black uppercase tracking-widest rounded-3xl hover:shadow-[0_0_50px_rgba(52,194,122,0.3)] transition-all flex items-center gap-3 text-lg leading-none">
