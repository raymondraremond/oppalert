      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
          ...
          <div className="space-y-8 animate-fade-up animate-delay-100">
            <div className="glass-gradient border border-white/5 rounded-[2.5rem] p-10 space-y-10 relative overflow-hidden group">
              <div className="absolute top-0 right-0 w-32 h-32 bg-amber/5 blur-3xl -z-10" />
              
              <h2 className="font-syne text-3xl font-black text-white">Contact Information</h2>
              ...
              <div className="space-y-6">
                {[
                  ...
                  <div key={idx} className="flex gap-6 group/item">
                    <div className="w-12 h-12 rounded-2xl bg-white/5 border border-white/10 flex items-center justify-center text-amber group-hover/item:scale-110 transition-transform shadow-inner">
                      <item.icon size={20} />
                    </div>
                    <div>
              ...
              <div className="pt-8 border-t border-white/5">
                <p className="text-xs font-black uppercase tracking-[0.2em] text-muted-dark mb-6">Our Global Reach</p>
                <div className="flex gap-4">
                  {[...Array(4)].map((_, i) => (
                    <div key={i} className="w-10 h-10 rounded-full bg-white/5 border border-white/5 flex items-center justify-center grayscale opacity-40">
                      <Globe size={18} />
                    </div>
                  ))}
            ...
            <div className="bg-primary/5 border border-primary/20 rounded-[2.5rem] p-10 group overflow-hidden relative">
              ...
              <div className="flex items-center gap-4 mb-4">
                 ...
                 <h3 className="font-syne text-xl font-black text-white">Live Support</h3>
              </div>
          ...
          <div className="animate-fade-up animate-delay-200">
            <div className="glass-gradient border border-white/10 rounded-[3rem] p-10 md:p-14 shadow-premium relative">
              {submitted ? (
                <div className="text-center py-20 animate-fade-up">
                  ...
                  <h2 className="font-syne text-3xl font-black text-white mb-4">Message Received</h2>
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  <h2 className="font-syne text-3xl font-black text-white mb-8">Send a Message</h2>
                  
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div className="space-y-2">
                      <label className="text-[10px] font-black uppercase tracking-widest text-muted-dark ml-1">Full Name</label>
                      <input required className="w-full bg-white/5 border border-white/10 rounded-2xl p-4 text-sm font-bold text-white focus:outline-none focus:border-amber/30 transition-all" placeholder="Adewale Okafor" />
                    </div>
                    <div className="space-y-2">
                      <label className="text-[10px] font-black uppercase tracking-widest text-muted-dark ml-1">Email Address</label>
                      <input required type="email" className="w-full bg-white/5 border border-white/10 rounded-2xl p-4 text-sm font-bold text-white focus:outline-none focus:border-amber/30 transition-all" placeholder="adewale@mail.com" />
                    </div>
                  </div>

                  <div className="space-y-2">
                    <label className="text-[10px] font-black uppercase tracking-widest text-muted-dark ml-1">Subject</label>
                  ...
                  <div className="space-y-2">
                    <label className="text-[10px] font-black uppercase tracking-widest text-muted-dark ml-1">Your Message</label>
                    <textarea required className="w-full bg-white/5 border border-white/10 rounded-3xl p-6 text-sm font-bold text-white focus:outline-none focus:border-amber/30 transition-all h-40 resize-none" placeholder="How can we help you?" />
                  </div>
                  ...
                  <p className="text-[10px] text-center text-muted-dark font-medium leading-relaxed uppercase tracking-widest mt-6">
