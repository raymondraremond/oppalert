      ...
      <div className="container mx-auto max-w-6xl">
        <div className="text-center mb-16 relative">
          ...
          <h1 className="font-serif text-5xl md:text-7xl font-bold text-primary mb-6 tracking-tight">
            Choose Your <span className="text-emerald italic">Edge.</span>
          </h1>
        ...
        <section className="mb-24">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto">
            {/* FREE SEEKER */}
            <div className="p-10 bg-surface/30 border border-border rounded-3xl flex flex-col hover:border-emerald/30 transition-all duration-300">
              <div className="mb-10">
            ...
            {/* PREMIUM SEEKER */}
            <div className="p-10 bg-surface/40 border-2 border-emerald rounded-3xl relative shadow-glow-emerald flex flex-col scale-105 z-10 overflow-hidden">
              <div className="absolute top-0 right-0 px-6 py-2 bg-gradient-to-l from-emerald to-emerald-light text-[#080A07] text-[10px] font-black uppercase rounded-bl-xl tracking-widest shadow-sm">Best Value</div>
              
              <div className="mb-10 pt-2">
                <h3 className="text-xs font-bold text-emerald uppercase tracking-widest mb-3 flex items-center gap-2">
              ...
              <ul className="space-y-4 mb-12 flex-1">
                <li className="text-sm text-primary/90 flex items-start gap-3"><CheckCircle2 size={18} className="text-emerald shrink-0 mt-0.5" /> <strong>48h Early Access</strong> to all listings</li>
                <li className="text-sm text-primary/90 flex items-start gap-3"><CheckCircle2 size={18} className="text-emerald shrink-0 mt-0.5" /> Exclusive Premium-only grants/jobs</li>
                <li className="text-sm text-primary/90 flex items-start gap-3"><CheckCircle2 size={18} className="text-emerald shrink-0 mt-0.5" /> Instant WhatsApp/Email alerts</li>
                <li className="text-sm text-primary/90 flex items-start gap-3"><CheckCircle2 size={18} className="text-emerald shrink-0 mt-0.5" /> Priority CV review service</li>
              </ul>
              <Link href="/register" className="w-full py-4 bg-gradient-to-r from-emerald to-emerald-light text-[#080A07] font-bold rounded-xl text-center hover:shadow-glow-emerald transition-all shadow-sm">
                Unlock Elite Access
              </Link>
            </div>
          </div>
        ...
        <section className="mb-32">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            {/* ORGANIZER PREMIUM */}
            <div className="p-10 bg-surface/30 border border-emerald/30 hover:border-emerald/60 rounded-3xl flex flex-col transition-all duration-300 relative">
              <div className="mb-10">
                <h3 className="text-xs font-bold text-emerald uppercase tracking-widest mb-3 flex items-center gap-2">
              ...
              <ul className="space-y-4 mb-12 flex-1">
                <li className="text-sm text-primary/90 flex items-start gap-3"><CheckCircle2 size={18} className="text-emerald shrink-0 mt-0.5" /> <strong>Homepage Banner</strong> (7 Days)</li>
                <li className="text-sm text-primary/90 flex items-start gap-3"><CheckCircle2 size={18} className="text-emerald shrink-0 mt-0.5" /> Email Blast to 50k+ members</li>
                <li className="text-sm text-primary/90 flex items-start gap-3"><CheckCircle2 size={18} className="text-emerald shrink-0 mt-0.5" /> Advanced Analytics Dashboard</li>
                <li className="text-sm text-primary/90 flex items-start gap-3"><CheckCircle2 size={18} className="text-emerald shrink-0 mt-0.5" /> Dedicated Account Manager</li>
              </ul>
              <Link href="/register" className="w-full py-4 bg-transparent border border-emerald/50 text-emerald font-bold rounded-xl text-center hover:bg-emerald/10 transition-all">
                Get Premium
              </Link>
            </div>
          </div>
        ...
        <div className="max-w-3xl mx-auto space-y-6">
          ...
          <div className="p-8 bg-surface/30 border border-border rounded-3xl hover:border-emerald/30 transition-colors">
