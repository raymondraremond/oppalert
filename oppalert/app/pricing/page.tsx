        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-20">
          ...
          <div className="p-10 bg-bg2 border-2 border-[#E8A020] rounded-[3rem] relative shadow-glow-amber flex flex-col scale-105 z-10">
            ...
            <div className="mb-10">
              ...
              <div className="text-5xl font-black text-primary mb-4">2,500 <span className="text-lg font-bold text-subtle">NGN/month</span></div>
          ...
          {/* ORGANIZER PRO */}
          <div className="p-10 bg-bg2 border border-[#8B5CF6] rounded-[3rem] flex flex-col">
            <div className="mb-10">
              <h3 className="text-sm font-black text-[#8B5CF6] uppercase tracking-widest mb-2">Organizer Pro</h3>
              <div className="text-4xl font-black text-primary mb-4">45,000 <span className="text-lg font-bold text-subtle">NGN/month</span></div>
              <p className="text-sm text-muted">For event organizers and community leaders.</p>
            </div>
            <ul className="space-y-5 mb-12 flex-1">
              <li className="text-sm text-primary flex items-center gap-3"><Crown size={16} className="text-[#8B5CF6]" /> Unlimited Event creation</li>
              <li className="text-sm text-primary flex items-center gap-3"><Crown size={16} className="text-[#8B5CF6]" /> Real-time registration tracking</li>
              <li className="text-sm text-primary flex items-center gap-3"><Crown size={16} className="text-[#8B5CF6]" /> Attendee data export (CSV)</li>
              <li className="text-sm text-primary flex items-center gap-3"><Crown size={16} className="text-[#8B5CF6]" /> Email notification system</li>
              <li className="text-sm text-primary flex items-center gap-3"><Crown size={16} className="text-[#8B5CF6]" /> Custom event landing pages</li>
            </ul>
