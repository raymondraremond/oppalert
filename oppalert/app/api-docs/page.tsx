    ...
    <div className="min-h-screen bg-bg text-primary pt-32 pb-40 px-6 relative overflow-hidden">
      ...
      <div className="container mx-auto max-w-7xl">
        <div className="max-w-4xl mb-24 space-y-8 animate-fade-up">
          ...
          <h4 className="text-[10px] font-black text-emerald uppercase tracking-[0.4em] mb-4">Developer Interface</h4>
          <h1 className="font-serif text-6xl md:text-8xl font-black mb-8 tracking-tight leading-none">
            API <span className="text-emerald italic">Engine.</span>
          </h1>
           ...
           <div className="space-y-20 animate-fade-up">
              ...
              <section className="space-y-8">
                 <div className="flex items-center gap-4">
                    ...
                    <h2 className="text-[12px] font-black uppercase tracking-[0.3em] text-muted flex items-center gap-3">
                      <Terminal size={18} className="text-emerald" /> Authentication Protocol
                    </h2>
                 </div>
                 ...
                 <div className="bg-surface/30 backdrop-blur-xl border border-border/60 rounded-[2rem] p-10 font-mono text-sm group relative shadow-premium overflow-hidden">
                    <div className="absolute top-0 right-0 w-32 h-32 bg-emerald/5 blur-[60px] opacity-40" />
                    <div className="flex items-center gap-4 relative z-10">
                       <span className="text-emerald/80 font-black">Authorization:</span> 
                       <span className="text-emerald">Bearer</span> 
                       <span className="text-primary font-bold tracking-widest opacity-40">NEXUS_SIG_XXXX_TERMINAL</span>
                    </div>
                    <button 
                      onClick={() => copyToClipboard('Authorization: Bearer YOUR_API_KEY', 'auth')} 
                      className="absolute right-6 top-1/2 -translate-y-1/2 p-4 bg-surface2 border border-border rounded-2xl text-muted hover:text-emerald transition-all shadow-xl active:scale-90"
                    >
              ...
              <section className="space-y-8">
                 <div className="flex items-center gap-4">
                    <div className="w-10 h-1 bg-emerald/30 rounded-full" />
                    <h2 className="text-[12px] font-black uppercase tracking-[0.3em] text-muted flex items-center gap-3">
                      <Cpu size={18} className="text-emerald" /> Direct Data Nodes
                    </h2>
                 </div>
                         ...
                         <div className="bg-surface/30 backdrop-blur-xl border border-border/60 rounded-[2rem] overflow-hidden transition-all duration-500 hover:bg-surface/50 group/item">
                            <div className="px-8 py-6 flex items-center justify-between border-b border-white/5 bg-white/[0.01]">
                               <div className="flex items-center gap-6">
                                  <span className={`text-[9px] font-black px-4 py-1.5 rounded-full shadow-inner ${ep.method === 'GET' ? 'bg-emerald/10 text-emerald border border-emerald/20' : 'bg-emerald/10 text-emerald border border-emerald/20'}`}>
                                    {ep.method}
                                  </span>
                                  <code className="text-[13px] font-black text-primary font-mono opacity-80 group-hover/item:text-emerald transition-colors">{ep.path}</code>
                               </div>
              ...
              <section className="space-y-8">
                 <div className="flex items-center gap-4">
                    <div className="w-10 h-1 bg-emerald/30 rounded-full" />
                    <h2 className="text-[12px] font-black uppercase tracking-[0.3em] text-muted flex items-center gap-3">
                      <FileJson size={18} className="text-emerald" /> Response Architecture
                    </h2>
                 </div>
    ...
    "sig_token": "verified_nexus_cluster"
           ...
           <aside className="sticky top-32 space-y-10 animate-fade-up" style={{ animationDelay: '300ms' }}>
              <div className="p-12 rounded-[3.5rem] bg-surface/30 backdrop-blur-3xl border border-border/50 relative overflow-hidden shadow-premium">
                 <div className="absolute top-0 right-0 w-32 h-32 bg-emerald/5 blur-[80px] rounded-full animate-pulse-soft" />
                 <div className="w-16 h-16 rounded-2xl bg-emerald/10 border border-emerald/20 flex items-center justify-center text-emerald mb-10 shadow-glow-emerald">
                    <Key size={32} />
                 </div>
                 ...
                 <Link href="/contact" className="w-full flex items-center justify-center bg-emerald text-black py-5 rounded-2xl font-black text-[10px] uppercase tracking-[0.2em] shadow-xl shadow-emerald/10 hover:scale-[1.02] active:scale-[0.98] transition-all">
              ...
              <div className="p-10 rounded-[3rem] bg-surface/30 backdrop-blur-3xl border border-border/50 relative overflow-hidden group">
                 <div className="absolute top-0 right-0 w-24 h-24 bg-emerald/5 blur-[60px] rounded-full" />
                 ...
                 <div className="space-y-6">
                    <div className="flex items-center justify-between">
                       ...
                       <span className="text-xs font-mono font-black text-emerald">100/m</span>
                    </div>
                    <div className="h-1.5 bg-bg rounded-full overflow-hidden">
                       <div className="h-full bg-emerald/40 w-1/4 rounded-full" />
                    </div>
