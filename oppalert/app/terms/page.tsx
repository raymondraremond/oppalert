      ...
      <div className="max-w-4xl mx-auto">
        <div className="mb-20 animate-fade-up">
           <h1 className="font-syne text-5xl md:text-7xl font-black tracking-tighter mb-6 text-primary">
             Terms of <span className="text-emerald-gradient drop-shadow-glow-emerald">Service</span>
           </h1>
        ...
        <div className="space-y-12 animate-fade-up animate-delay-100">
          {terms.map((term, idx) => (
            <div key={idx} className="glass-gradient border border-[var(--border)] rounded-[2.5rem] p-10 group hover:border-[var(--glass-border)] transition-all">
              <h2 className="font-syne text-2xl font-black text-primary mb-6 group-hover:text-emerald transition-colors">{term.title}</h2>
          ...
          <div className="bg-emerald/5 border border-emerald/20 rounded-[2.5rem] p-10 md:p-14 text-center">
            ...
            <a href="mailto:hello@OppFetch.com" className="text-emerald font-black uppercase tracking-widest text-xs hover:underline underline-offset-8">I have a legal question</a>
          </div>
        </div>
